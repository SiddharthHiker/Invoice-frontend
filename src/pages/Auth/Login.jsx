      ...
      <div className="w-full max-w-sm">
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                onBlur={handleBlur}
                className={`w-full pl-12 pr-4 py-3 border rounded-lg focus:ring-2 focus:border-transparent outline-none transition-all ${fieldErrors.email && touched.email
          ...
          <div>
            ...
            <div className="relative">
              <Lock className='absolute left-4 top-1/2 transform-translate-1/2 text-gray-400 w-5 h-5' />
              <input
                name="password"
          ...
          <button
            ...
            className='w-full bg-gradient-to-r from-blue-950 to-blue-900 text-white py-3 px-4 rounded-lg font-medium hover:bg-gray-800 disabled:bg-gray-300 disable:cursor-not-allowed transition-colors flex items-center justify-center group'
          >
            {isLoading ? (
              <>
