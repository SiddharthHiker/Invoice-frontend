...
const FaqItem = ({ faq, isOpen, onClick }) => (
    <div className='border border-gray-200 rounded-xl overflow-hidden'>
        <button onClick={onClick} className='w-full flex items-center justify-between p-6 bg-white hover:bg-gray-50 cursor-ponter transition-colors duration-200'>
        ...
        <section id="faq" className='py-20 lg:py-28 bg-white'>
            <div className='max-w-4xl mx-auto px-4 sm:px-6 lg:px-8'>
                <div className='text-center mb-16'>
                    <h2 className='text-3xl sm:text-4xl font-extrabold text-gray-900 mb-4'>Frequently Asked Question</h2>
